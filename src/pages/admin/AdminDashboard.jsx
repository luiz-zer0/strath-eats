...
const NAV = [
  ...
  { key: 'stalls',   label: 'Stalls',     icon: '🍽️' },
]
        ...
        {NAV.map(item => (
          <button
            ...
            style={{
              ...
              background: tab === item.key ? 'rgba(167,139,250,0.12)' : 'transparent',
              color: tab === item.key ? '#a78bfa' : '#94a3b8',
                ...
                return (
                  ...
                  >
                    ...
                    <td style={{ padding: '12px 16px', fontSize: 11, color: '#94a3b8', whiteSpace: 'nowrap' }}>
                      {order.type === 'Dine-in' ? '🪑' : '🛍️'} {order.type}
                    </td>
            ...
            <div key={stall.id} style={{ ...card, borderLeft: `3px solid ${isActive ? '#4ade80' : '#f87171'}` }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 14 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                  <div style={{ fontSize: 32 }}>{stall.emoji}</div>
                  <div>
