      ...
      <div className="py-24 px-8 bg-navy">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-2 gap-8">
            {[
              { icon: '📱', title: 'Live Menus', desc: 'Real-time updates from every stall on campus' },
              { icon: '💳', title: 'M-Pesa Payments', desc: 'Safe and secure mobile money checkout' },
              { icon: '📊', title: 'Vendor Tools', desc: 'Orders, menu management, and analytics' },
              { icon: '⚡', title: 'Instant Tracking', desc: 'See your order status as it progresses' },
              { icon: '📈', title: 'Admin Insights', desc: 'Platform analytics and stall management' },
              { icon: '🔔', title: 'Smart Notifications', desc: 'Get alerts when your order is ready' },
            ].map((feat, i) => (
              <div
                key={i}
