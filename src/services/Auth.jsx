...
const ROLE_CFG = {
  student: { label: 'Student',        emoji: '🎓', idLabel: 'Student ID', idPlaceholder: 'e.g. 191603',   color: '#3b82f6' },
  staff:   { label: 'Staff / Lecturer', emoji: '👩‍🏫', idLabel: 'Staff ID',   idPlaceholder: 'e.g. STF-042', color: '#4ade80' },
  other:   { label: 'Guest',          emoji: '👤', idLabel: 'Visitor ID', idPlaceholder: 'Optional',     color: '#a78bfa' },
}
        ...
        <div style={{ width: '100%', maxWidth: 420 }}>
          ...
          <div style={{ background: '#141d35', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 18, padding: 24 }}>
            <form onSubmit={handleSubmit}>
              ...
              <Input label="Strathmore email" type="email" placeholder={role === 'other' ? 'your@email.com' : 'l.ngatia@strathmore.edu'} value={form.email} onChange={set('email')} />
